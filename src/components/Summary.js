const Summary = () => {
	return (
		<div className='font-PF w-8/12 pt-6 pl-6 pr-2 text-base absolute right-1/3 leading-5 md:-left-0.5 lg:text-xl lg:w-4/12 lg:mr-40'>
			<p>
				I'm a{' '}
				...
				<span className='italic font-black text-pale-cerulean'>design</span> and
