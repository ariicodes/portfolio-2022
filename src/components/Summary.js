const Summary = () => {
	return (
		<div className='font-PF w-8/12 pt-6 pl-6 pr-2 text-base absolute right-1/3 leading-snug md:-left-0.5 lg:w-[32.5%] lg:mr-40'>
			<p>
				I'm a{' '}
				<span className='italic text-pale-cerulean'>
					software engineer
				</span>{' '}
				based in the United States who uses both sides of the brain. My eye for{' '}
				<span className='italic text-pale-cerulean'>design</span> and
